...
const controller = require('../../controllers/admin/processingRecordAdminController');
const { createValidator, updateValidator } = require('../../validators/processingRecordValidator');
